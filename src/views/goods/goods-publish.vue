        ...
        <div class="list-img-box">
          <div
            ...
            <div class="upload-list-cover">
              <i type="el-icon-view" @click.native="handleView(formValidate.mainImage)"></i>
              <i type="el-icon-delete" @click.native="formValidate.mainImage=''"></i>
            </div>
          </div>
      ...
      <el-form-item label="商品附图" prop="subImages">
        <div class="list-img-box">
          <div
            ...
            <div class="upload-list-cover">
              <i type="el-icon-view" @click.native="handleView(item.url)"></i>
              <i type="el-icon-delete" @click.native="handleRemove(item)"></i>
            </div>
          </div>
        ...
        <el-form-item label="视频封面" prop="videocove">
          <div class="list-img-box">
            <div
              ...
              <div class="upload-list-cover">
                <i type="el-icon-view" @click.native="handleView(formValidate.videocove)"></i>
                <i type="el-icon-delete" @click.native="formValidate.videocove=''"></i>
              </div>
            </div>
...
//      this.formValidate=this.formdata;
    ...
    watch:{
      ...
      switchPostage(val,oldval){
        val == true ? this.formValidate.conditionalMail = 0 : this.formValidate.conditionalMail = ''
      },
      //附图数组
